package com.mesosphere.sdk.geode.scheduler;
...
public class ServiceTest {
    ...
    public void testSpec() throws Exception {
        ...
        ticks.add(Send.offerBuilder("locator").build());
        ticks.add(Expect.launchedTasks("locator-0-locator"));
        ticks.add(Send.taskStatus("locator-0-locator", Protos.TaskState.TASK_ERROR).build());
        ...
        ticks.add(Send.offerBuilder("locator").setPodIndexToReoffer(0).build());
        ticks.add(Expect.launchedTasks("locator-0-locator"));
        ticks.add(Send.taskStatus("locator-0-locator", Protos.TaskState.TASK_RUNNING).build());
